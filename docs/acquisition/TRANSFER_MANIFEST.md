# Transfer manifest â€” Atlas of Knowledge

## Schedule A â€” Included (typical)

1. Git repository `theworker02/atlas-of-knowledge` (or content transfer)
2. Original Product source/docs as of closing tag
3. `docs/acquisition/` diligence materials
4. In-repo marks created for Atlas of Knowledge
